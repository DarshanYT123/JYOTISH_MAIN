...
const Report = ({setAction, action}) => {
  ...
  return (
    ...
    <>
     <div className='md:px-16 py-10 px-10'>
      ...
      <div className='content-tabs  flex flex-row flex-wrap justify-between items-center'>
        <TabContent id="tab1" activeTab={activeTab}>
          <div className={activeTab === "tab1" ? "content active-content" : "content "}>
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-10 justify-between items-center'>
              {product.map(({ image, title, customers, tagline, qty, price, id }, index) => {
                return (
                  
                  <div className=' md:mx-auto lg:mx-0'>
                    <div className="md:w-[444px] md:h-[250px] w-[290px] h-[190px] bg-neutral-50 rounded-[10px] shadow lg:mx-auto md:mx-auto md:flex flex relative" key={id}>
                      ...
                      <img src={image} className='md:w-[205px] md:h-[240px] w-[120px] h-[180px] md:px-[10px] md:pt-[15px] px-[6px] pt-[10px] object-cover md:rounded-[5px] rounded-[2.5px]' />
                      <div className='md:pl-[15px] pl-[10px] flex flex-col justify-center items-start'>
                        <p className="md:w-[155px] w-[100px] truncate text-amber-900 md:text-[20px] text-[16px] font-medium font-['Lexend'] md:pt-[15px]">{title}</p>
                        ...
                        <p className="opacity-80 text-neutral-700 md:text-[16px] text-[12px] font-medium font-['Lexend'] leading-7 md:pt-[16px] pt-[6px]">Price: &#8377;<span className="text-neutral-700 md:text-base text-xs font-medium font-['Lexend'] leading-7">{price}</span></p>
                        <div className='flex md:py-[4px] justify-center items-center gap-x-2.5 '>
                          <NavLink to="/cart"  onClick={() => { setStepNo(2); setAction("buy"); buyNow(image, title, customers, tagline, price, qty, id); }}>
                          <button  className="md:w-[131px] md:h-[32px] w-[100px] h-[26px] bg-amber-500 md:rounded-lg rounded-md border border-amber-500 text-center text-white md:text-base text-xs font-medium font-['Lexend']">Buy Now</button>
                          </NavLink>
                          
                          <NavLink to="/cart" 
                           onClick={() => { setStepNo(1); setAction("cart"); addToCart(image, title, customers, tagline, price, qty, id); }}>
                           <button className='md:px-5 lg:px-4 hover:duration-1000 hover:bg-[#04B4DB] group py-1 border border-[#04B4DB] rounded-[8px]  '>
                ...
                return (
                  ...
                  <div className='md:py-[10px] md:mx-auto lg:mx-0 py-[5px]'>
                    <div className="md:w-[444px] md:h-[250px] w-[290px] h-[190px] bg-neutral-50 rounded-[10px] shadow lg:mx-auto md:mx-auto md:flex flex relative" key={id}>
                      <ShareOutlinedIcon className='absolute top-[14px] right-[14px]' sx={{ '@media (min-width:300px)': { fontSize: '14px', },'@media (min-width:768px)': { fontSize: '24px', }, '@media (min-width:960px)': { fontSize: '24px', }, }} />
                      <img src={image} className='md:w-[205px] md:h-[240px] w-[120px] h-[180px] md:px-[10px] md:pt-[15px] px-[6px] pt-[10px] object-cover md:rounded-[5px] rounded-[2.5px]' />
                      <div className='md:pl-[15px] pl-[10px] md:pt-[30px] flex flex-col justify-center items-start'>
                      <p className="md:w-[155px] w-[100px]  text-amber-900 md:text-[20px] text-[16px] font-medium font-['Lexend'] md:pt-[15px]">{title}</p>
                        <div className='flex flex-row'>
                                    <div className='text-amber-500 '>
                                        <StarRateIcon sx={{ '@media (min-width:300px)': { fontSize: '14px', },'@media (min-width:768px)': { fontSize: '24px', }, '@media (min-width:960px)': { fontSize: '24px', }, }} />
                                        <StarRateIcon sx={{ '@media (min-width:300px)': { fontSize: '14px', },'@media (min-width:768px)': { fontSize: '24px', }, '@media (min-width:960px)': { fontSize: '24px', }, }} />
                        ...
                        <p className="text-cyan-500 md:text-[12px] text-[10px] text-start font-normal font-['Lexend']">{customers}</p>
                        <p className="md:w-[207px] w-[190px] text-neutral-400 md:text-[14px] text-[12px] text-start font-normal font-['Poppins'] leading-normal md:pt-[21px] pt-[14px] ">{tagline}</p>
                        {/* <p className="opacity-80 text-neutral-700 md:text-[16px] text-[12px] font-medium font-['Lexend'] leading-7 md:pt-[16px] pt-[6px]">Price: &#8377;<span className="text-neutral-700 md:text-base text-xs font-medium font-['Lexend'] leading-7">{price}</span></p> */}
                        <NavLink to="/dwnld" onClick={() => dwnldProduct(image, title, tagline, id)}>
                        <div className='flex md:py-[50px] pt-[30px] '>
                          <button className="md:w-[205px] md:h-[32px] w-[165px] h-[27px] bg-amber-500 md:rounded-lg rounded-md border border-amber-500 text-center text-white md:text-base text-xs font-medium font-['Lexend']">Download Now</button>
                        </div>
                        </NavLink> 
                      </div>
                    </div>
