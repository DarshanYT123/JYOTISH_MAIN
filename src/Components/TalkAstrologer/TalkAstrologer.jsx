    ...
    const Data = [
        {
            ...
            text1:"7899",
            text2:"Orders",
            text3:"Job, Career, Finance, Marriage, Love, Relationships, Education, Health",
            name:"Acharya Aditya",
    ...
    <div className='flex flex-row bg-white pt-2  rounded-[6px]'>
        <div className='flex flex-col py-4'>
            <div className='md:px-2 lg:px-3 px-3 '>
                <img src={item.img1} className='w-24 md:w-28 lg:w-52' alt=''/>
                </div>
                <div className='flex flex-col justify-start items-center gap-x-2 px-4  py-2'>
                <img src={item.img2} className='w-20 md:w-28 lg:w-40' alt=''/>
        ...
        <div>
            ...
            <img src={item.img3} className='w-5 md:w-7' alt=''/>
...
<h2 className="text-[color:var(--Black-text-color,#3A3A3A)] text-[16px] font-Lexend not-italic font-medium leading-[normal]">{item.exp}</h2>
                ...
                <div>
                    <h2 className="text-[color:var(--grey-1,#A1A1A1)] text-[10px] font-Lexend text-start not-italic font-medium leading-[normal]">{item.text3}</h2>
                </div>
 ...
 <img src={item.img4} className='w-5' alt=''/>
                <button className=' text-white  text-[16px] font-Lexend  not-italic font-medium leading-[normal]'>{item.call}</button>
                </div>
            </div>
                </div>
                </div>
