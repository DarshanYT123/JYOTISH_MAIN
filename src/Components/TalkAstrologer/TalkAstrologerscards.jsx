                ...
                <div className="grid grid-flow-cols grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 " >
                {
                   filteredData.map((item)=>{
                        ...
                        return(
                            <>
                            <div key={item.id}>
                             <div className={` p-[1.5px] relative md:w-[21.3rem] lg:w-[26rem]  hover:bg-[#FFA300]   shadow-[0px_4px_10px_0px_rgba(174,174,174,0.25)] overflow-x-hidden  rounded-[6px] `}>
...
export default TalkAstrologerscards;
